...
Recursive top-down approach:
  Recursively breaks down array into two subarrays 
    & recursively sorts them.
  Breaks down subarrays until they have only 1 element 
    (implying they are sorted).
  
Iterative bottom-up approach:
  Splits array into sublists of size 1,
  merges adjacent sublists into sorted lists,
  repeats until no more sublists.
...
Optimization:
- Refactors your iterative solution to a natural merge sort
    (initial subarrays become naturally occurring sorted sequences)
